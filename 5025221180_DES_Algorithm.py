...
def Encrypt():
    ...
    if len(initialKey) < 8 or len(initialKey) > 8:
        ...
        # Mengambil angka angka biner dari binkey ke dalam pclist dengan menggunakan array pc1
        ...
        # PC 2 digunakan untuk mengurangi bit dari key PC1 (56 bit) menjadi 48 bit
        ...
        if len(initialMsg) < 9 or len(initialMsg) > 9:
            ...
            # Melakukan permutasi terhadap plainText dengan menggunakan array IP (Initial Permutation)
...
Label1 = Label(T, text="Key", font="Calibri", bg="#00ffd0").place(x=60, y=60)
ED_Key = Entry(T, textvariable=mainKey, font="Calibri", width="50").place(x=60, y=100)


Label2 = Label(T, text="The Plain Text", font="Calibri", bg="#00ffd0").place(x=140, y=160)
clearBtn1 = Button(T, text="Clear", width="8", font="Calibri", command=clear1).place(x=180, y=310)


Label3 = Label(T, text="The Cipher Text", font="Calibri", bg="#00ffd0").place(x=560, y=160)
